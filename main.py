...
def parse_args():
    ...
    parser.add_argument('--cfg', dest='cfg_file',
                        ...
                        default='cfg/pororo.yml', type=str) # cfg/bird.yml
...
def sampling_2(text_encoder, netG, cap, wordtoix, device, idx):
    model_dir = cfg.TRAIN.NET_G
    istart = cfg.TRAIN.NET_G.rfind('_') + 1
    iend = cfg.TRAIN.NET_G.rfind('.')
    start_epoch = int(cfg.TRAIN.NET_G[istart:iend])
    ...
    for num_epoch in [120]:
        ...
        captions, cap_lens = text2cap(cap, wordtoix)
        input_sen_size = 1
        
        hidden = text_encoder.init_hidden(input_sen_size)
...
if __name__ == "__main__":
    ...
    # print("-----------------",dataset.n_words,"------------------------",state_dict)
    ...
    # user_input_1 = input('1 입력하면 사용자 값 넣음') # 추가
    ...
    #     # cap ="Pororo is on a land covered with snow. Pororo starts to sweep off the snow around it." #10 2 문장 예시
    #     cap = "Pororo is saying hello with smile." # 15 1문장 예시
    #     sampling_2(text_encoder, netG, cap, wordtoix, device, idx)
