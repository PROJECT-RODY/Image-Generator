...
class TextDataset(data.Dataset):
    def __init__(self, data_dir, split='train',
        ...
        # self.embeddings_num = cfg.TEXT.CAPTIONS_PER_IMAGE 수정
        ...
        if data_dir.find('pororo') != -1: # 수정 birds
    ...
    def load_filenames(self, data_dir, split):
        # filepath = '%s/%s/filenames.pickle' % (data_dir, split) # 수정
    ...
    def __getitem__(self, index):
        ...
        if self.bbox is not None:
            ...
            if self.split_name == 'train':
                # data_dir = '/data/scene_understanding/coco2014/train2014' # 수정
                data_dir = './data/pororos/pororo'
            else:
                # data_dir = '/data/scene_understanding/coco2014/val2014'
                data_dir = './data/pororos/pororo'
                
        #
        img_name = '%s/%s.png' % (data_dir, key)
